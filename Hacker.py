def hacker(diractory):
	...
	for file in py_files_list*4:#*4 because i have few py files in this devise so i repeted it multipal times
		total_line=getnumline(file)#this is a userbilt function that tells us how many lines of code is written
...
hacker('/storage/emulated/0/')#you can give your diractory and spacific diractris also